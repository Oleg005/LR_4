...
public class PizzaController {
    ...
    @GetMapping("/get")
    @Description("Метод приносить всю піцу")
    ...
    @GetMapping("/get/{id}")
    @Description("Метод приносить піцу з ідентифікатором.")
    ...
    @PutMapping("/edit/{id}")
    @Description("Метод редагує піцу з ідентифікатором.")
    ...
    @Description("Метод видаляє піцу з ідентифікатором")
